          ...
          <div className='flex flex-col gap-12'>
            <div className='flex flex-col justify-center items-center gap-10 lg:gap-16'>
              <motion.div
                ...
                <h2 className="max-w-4xl text-center">
                  Empowering ideas through{' '}
                  <span className='instrument-font italic font-normal dark:text-white/100'>
            ...
            <motion.div
              ...
              <h4 className='text-white text-center xl:text-left'>
                From idea to impact <br/> let’s build something remarkable together.
              </h4>
